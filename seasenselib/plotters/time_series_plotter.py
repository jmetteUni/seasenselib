...
This module supports plotting single or multiple parameters in time series plots
with advanced features like dual y-axes, normalization, and custom styling.
"""
...
class TimeSeriesPlotter(AbstractPlotter):
    """Creates time series plots for one or more parameters in the CTD dataset.
    
    This class specializes in creating time series plots showing how one or more
    ...
    def add_cli_arguments(cls, parser):
        ...
        parser.add_argument('--line-styles', type=str, nargs='*',
